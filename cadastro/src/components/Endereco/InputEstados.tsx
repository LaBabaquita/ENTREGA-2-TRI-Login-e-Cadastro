...
type props = {
    ...
    endereco: {
        ...
        bairro: string;
        logradouro: string;}
    setEstadoAtual: React.Dispatch<React.SetStateAction<{
        uf: string;
        localidade: string;
        bairro: string;
        logradouro: string;}>>
...
export default function ({cep, endereco, setEstadoAtual}: props) {
